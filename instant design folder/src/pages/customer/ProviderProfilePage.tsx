  ...
  return (
    <div className="min-h-full">
      ...
      <div className="bg-white border-b border-[#E2E6F0] px-6 py-4">
        <button onClick={() => navigate(-1)} className="flex items-center gap-2 text-sm text-[#565E74] hover:text-[#0D1B3E] transition-colors mb-4">
            ...
            <div className="flex-1">
              <div className="flex items-start justify-between gap-4 flex-wrap">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    onClick={() => navigate("/customer/book/p1")}
                    className="flex items-center gap-2 bg-[#002B95] hover:bg-[#001B63] text-white font-semibold text-sm px-5 py-2.5 rounded-[10px] transition-colors shadow-md shadow-[#002B95]/20"
                  >
      ...
      <div className="lg:hidden sticky bottom-0 bg-white border-t border-[#E2E6F0] p-4 flex gap-3">
        <button
          onClick={() => navigate("/customer/messages")}
          className="flex-1 border border-[#002B95] text-[#002B95] font-semibold text-sm py-3 rounded-[12px] hover:bg-[#EEF2FF] transition-colors"
        >
          Message
        </button>
        <button
          onClick={() => navigate("/customer/book/p1")}
          className="flex-1 bg-[#002B95] text-white font-semibold text-sm py-3 rounded-[12px] hover:bg-[#001B63] transition-colors"
        >
          Request Service
        </button>
      </div>
