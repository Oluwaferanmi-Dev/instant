...
export default function CustomerDashboard() {
  ...
  function handleSearch(e: React.FormEvent) {
    e.preventDefault();
    navigate(`/customer/search${search ? `?q=${encodeURIComponent(search)}` : ""}`);
  }
    ...
    <div className="p-6 max-w-5xl mx-auto space-y-8">
      ...
      <section>
        ...
        <div
          ...
          onClick={() => navigate("/customer/booking/bk001")}
        >
          ...
          <div className="flex flex-col items-end gap-2">
            ...
            <button
              onClick={(e) => { e.stopPropagation(); navigate("/customer/messages"); }}
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={() => navigate("/customer/search")} className="text-xs text-[#002B95] font-semibold hover:text-[#001B63] flex items-center gap-1">
