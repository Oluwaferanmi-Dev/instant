  ...
  if (cancelled) {
    return (
      <div className="max-w-md mx-auto px-6 py-20 text-center">
        ...
        <button onClick={() => navigate("/customer/search")} className="bg-[#002B95] text-white font-bold px-8 py-3 rounded-[12px] text-sm hover:bg-[#001B63] transition-colors">
      ...
      <div className="grid lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <div
            ...
            onClick={() => navigate("/customer/provider/p1")}
          >
        ...
        <div className="space-y-5">
          ...
          <div className="bg-white rounded-[16px] border border-[#E2E6F0] p-5 shadow-sm">
            ...
            <button
              onClick={() => navigate("/customer/payment/bk001")}
          ...
          <div className="bg-[#EEF2FF] rounded-[14px] p-4">
            ...
            <button
              onClick={() => navigate("/customer/review/bk001")}
