      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button onClick={() => navigate("/provider/requests")} className="text-xs text-[#002B95] font-semibold hover:text-[#001B63] flex items-center gap-1">
        ...
        <div className="space-y-5">
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <button onClick={() => navigate("/provider/requests")} className="text-xs text-[#002B95] font-semibold">View all</button>
            </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <button onClick={() => navigate("/provider/messages")} className="text-xs text-[#002B95] font-semibold">
                View all
              </button>
            </div>
