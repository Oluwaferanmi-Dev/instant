          ...
          <div key={req.id} className="bg-white rounded-[16px] border border-[#E2E6F0] p-5 shadow-sm">
            ...
            {confirmDecline === req.id && (
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
                <div className="bg-white rounded-[20px] p-6 max-w-sm w-full mx-4 shadow-2xl">
            ...
            {req.status === "requested" && (
              <div className="flex gap-2 mt-3">
                ...
                <button onClick={() => navigate("/provider/messages")} className="px-4 border border-[#E2E6F0] rounded-[10px] hover:bg-[#F8F9FC] transition-colors">
