      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-24">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link href="/#customer-waitlist" className="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-primary hover:bg-blue-700 transition-colors shadow-sm">
              Join Waitlist
            </Link>
            <Link href="/#provider-waitlist" className="inline-flex items-center justify-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-lg text-primary bg-white hover:bg-gray-50 transition-colors shadow-sm">
              Provider Sign Up
            </Link>
          </div>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white border-b border-gray-100 px-4 pt-2 pb-6 space-y-4 shadow-lg absolute w-full left-0 z-50">
          ...
          <div className="flex flex-col space-y-3 pt-4 border-t border-gray-100">
            <Link href="/#customer-waitlist" onClick={() => setIsMobileMenuOpen(false)} className="w-full inline-flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-primary hover:bg-blue-700 shadow-sm">
              Join Waitlist
            </Link>
            <Link href="/#provider-waitlist" onClick={() => setIsMobileMenuOpen(false)} className="w-full inline-flex items-center justify-center px-4 py-3 border border-gray-300 text-base font-medium rounded-lg text-primary bg-white hover:bg-gray-50 shadow-sm">
              Provider Sign Up
            </Link>
          </div>
        </div>
