...
import { Users, Briefcase, ShieldCheck, DollarSign, Clock, AlertTriangle, CheckCircle, ArrowRight, X } from "lucide-react";
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-[16px] border border-[#E2E6F0] shadow-sm overflow-hidden">
          <div className="px-5 py-4 border-b border-[#E2E6F0] flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button onClick={() => router.push("/admin/verifications")} className="text-xs text-[#002B95] font-semibold flex items-center gap-1 hover:text-[#001B63]">
        ...
        <div className="bg-white rounded-[16px] border border-[#E2E6F0] shadow-sm overflow-hidden">
          <div className="px-5 py-4 border-b border-[#E2E6F0] flex items-center justify-between">
            ...
            <button onClick={() => router.push("/admin/bookings")} className="text-xs text-[#002B95] font-semibold flex items-center gap-1 hover:text-[#001B63]">
              View all <ArrowRight size={12} />
            </button>
          </div>
          <div className="divide-y divide-[#F8F9FC]">
