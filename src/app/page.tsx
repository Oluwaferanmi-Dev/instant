          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex-shrink-0 flex items-center">
              <Link href="#" className="flex items-center gap-2">
                <svg className="h-8 w-auto text-primary" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24">
                  ...
                  <div className="rounded-[2rem] overflow-hidden w-[272px] h-[572px] bg-white relative pt-8">
                    ...
                    <div className="px-4 flex justify-between items-center mb-6">
                      <div className="flex items-center gap-1">
                        <svg className="h-5 w-auto text-primary" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"></path></svg>
                        <span className="font-bold text-sm italic">Instant</span>
                      </div>
