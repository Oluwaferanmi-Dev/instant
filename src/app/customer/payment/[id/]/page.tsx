    ...
    return (
      <div className="max-w-md mx-auto px-4 md:px-6 py-20 text-center">
        ...
        <div className="flex gap-3">
          <button onClick={() => router.push("/customer/review/bk001")} className="flex-1 bg-[#002B95] text-white font-bold py-3 rounded-[12px] text-sm hover:bg-[#001B63] transition-colors">
            Leave a review
          </button>
          <button onClick={() => router.push("/customer")} className="flex-1 border border-[#E2E6F0] text-[#565E74] font-semibold py-3 rounded-[12px] text-sm hover:bg-[#F8F9FC] transition-colors">
            Dashboard
          </button>
        </div>
      </div>
